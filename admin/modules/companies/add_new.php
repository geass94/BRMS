...
<form action="/index.php" method="POST" enctype="multipart/form-data">
	<input type="hidden" class="hidden" name="form_type" value="company_register">
...
<div class="form-group">
	...
	<select id="plan" name="plan" class="form-control">
		<option value="choose"> <?=$lang['not_choosen']?> </option>
		<option value="PLAN_BASIC"> <?=$lang['plan_basic']?> </option>
		<option value="PLAN_PRO"> <?=$lang['plan_pro']?> </option>
	</select>
</div>
<div class="form-group">
